module NotificationService
  class SubjectsUpdated
    ...
    def initialize(course:, previous_subject_names:, updated_subject_names:, previous_course_name:)
      @course = course
  ...
  private
    ...
    attr_reader :course, :updated_subject_names, :previous_subject_names, :previous_course_name
